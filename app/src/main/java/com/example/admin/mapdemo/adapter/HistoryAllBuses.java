...
import com.example.admin.mapdemo.fragment.BusesHistoryFragment;
import com.example.admin.mapdemo.model.BusListResult;

import java.util.List;

public class  HistoryAllBuses extends RecyclerView.Adapter<HistoryAllBuses.MyViewHolder> {

    private List<BusListResult> listResults;

    public HistoryAllBuses(List<BusListResult> listResults) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), BusHistoryActivity.class);
